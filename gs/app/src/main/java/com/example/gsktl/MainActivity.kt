...
import com.example.gsktl.adapter.PraiaAdapter
import com.example.gsktl.model.Praia
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recyclerView = findViewById<RecyclerView>(R.id.recyclerPraias)
        ...
        val btnAdd = findViewById<Button>(R.id.btnAddPraia)
        val etNomePraia = findViewById<EditText>(R.id.etNomePraia)
        val etCidadePraia = findViewById<EditText>(R.id.etCidadePraia)
        val etEstadoPraia = findViewById<EditText>(R.id.etEstadoPraia)
